<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Component.ascx.cs" Inherits="Goblinary.Website.Controls.Item.Component" %>
...
<%--        <li runat="server" class="detailsListItem">
        ...
        <li runat="server" class="detailsListItem">
            ...
            <asp:ListView runat="server" ID="ComponentRelatedRecipesListView">
                <LayoutTemplate>
                    <ul class="detailsList"><ul runat="server" id="itemPlaceholder" class="detailsList"></ul></ul>
                </LayoutTemplate>
                <ItemTemplate>
...
<asp:GridView ID="ItemBonusesGridView" runat="server" CssClass="tablesorter custom-popup" AutoGenerateColumns="false">
    <Columns>
        ...
        <asp:TemplateField HeaderText="Recipes" SortExpression="">
            <ItemTemplate>
                <p runat="server" class="noPad">
                    <asp:Label runat="server" Text='<%# Eval("RecipeName") %>' />
                </p>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
