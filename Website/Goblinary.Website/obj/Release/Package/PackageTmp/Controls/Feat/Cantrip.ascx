<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cantrip.ascx.cs" Inherits="Goblinary.Website.Controls.Feat.Cantrip" %>
<asp:DetailsView ID="FeatDetailsView" runat="server" AutoGenerateRows="false" CssClass="detailsView">
    ...
    <Fields>
        ...
        <asp:BoundField DataField="School_Name" HeaderText="School:" SortExpression="" />
