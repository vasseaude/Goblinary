<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NPCKillAchievement.ascx.cs" Inherits="Goblinary.Website.Controls.Achievement.NPCKillAchievement" %>
...
<asp:GridView ID="AchievementRanksGridView" runat="server" CssClass="tablesorter custom-popup" AutoGenerateColumns="false">
    <Columns>
        ...
        <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="" />
		<asp:BoundField DataField="Race_Name" HeaderText="What to Kill" SortExpression="" />
