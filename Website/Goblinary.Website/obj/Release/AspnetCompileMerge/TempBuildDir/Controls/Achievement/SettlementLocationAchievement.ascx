<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettlementLocationAchievement.ascx.cs" Inherits="Goblinary.Website.Controls.Achievement.SettlementLocationAchievement" %>
...
<asp:GridView ID="AchievementRanksGridView" runat="server" CssClass="tablesorter custom-popup" AutoGenerateColumns="false">
    <Columns>
		...
		<asp:BoundField DataField="Description" HeaderText="Description" SortExpression="" />
		<asp:BoundField DataField="Settlement_Name" HeaderText="Settlement Name" SortExpression="" />
