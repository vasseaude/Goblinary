<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HolySymbolSpell.ascx.cs" Inherits="Goblinary.Website.Controls.Feat.ClericSpell" %>
<asp:DetailsView ID="FeatDetailsView" runat="server" AutoGenerateRows="false" CssClass="detailsView">
    ...
    <Fields>
        ...
        <asp:BoundField DataField="Level" HeaderText="Spell Level:" SortExpression="" />
        <asp:TemplateField HeaderText="Attack Bonu:s" SortExpression="">
            <ItemTemplate>
