<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CampKit.ascx.cs" Inherits="Goblinary.Website.Controls.Item.Camp" %>
...
<asp:ListView runat="server" ID="ItemListView">
    ...
    <ItemTemplate>
		<li runat="server" class="detailsListItem">
            ...
            <asp:HyperLink runat="server" NavigateUrl='<%# "~/StructureDetails?structure=" + HttpUtility.UrlEncode(Eval("Camp_Name").ToString()) %>' Text='<%# Eval("Camp_Name") %>' CssClass="detailsListData" />
		</li>
		<li runat="server" class="detailsListItem">
