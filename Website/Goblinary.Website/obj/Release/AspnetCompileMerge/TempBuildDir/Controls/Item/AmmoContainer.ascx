<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AmmoContainer.ascx.cs" Inherits="Goblinary.Website.Controls.Item.AmmoContainer" %>
<asp:GridView ID="ItemsGridView" runat="server" CssClass="tablesorter custom-popup" AutoGenerateColumns="false">
    <Columns>
        ...
        <asp:BoundField DataField="AmmoContainerType_Name" HeaderText="Ammo Container Type" SortExpression="" />
    </Columns>
</asp:GridView>
<asp:ListView runat="server" ID="ItemListView">
    ...
    <ItemTemplate>
        ...
        <li runat="server" class="detailsListItem">
            <asp:Label runat="server" Text="Ammo Container Type:" CssClass="detailsListField"></asp:Label>
            <asp:Label runat="server" Text='<%# Eval("AmmoContainerType_Name") %>' CssClass="detailsListData"></asp:Label>
        </li>
        <li runat="server" class="detailsListItem">
