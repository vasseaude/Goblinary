<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Weapon.ascx.cs" Inherits="Goblinary.Website.Controls.Item.Weapon" %>
<asp:GridView ID="ItemsGridView" runat="server" CssClass="tablesorter custom-popup" AutoGenerateColumns="false">
    <Columns>
        ...
        <asp:BoundField DataField="WeaponType_Name" HeaderText="Weapon Type" SortExpression="" />
    </Columns>
</asp:GridView>
<asp:ListView runat="server" ID="ItemListView">
    ...
    <ItemTemplate>
        ...
        <li runat="server" class="detailsListItem">
            <asp:Label runat="server" Text="Weapon Type:" CssClass="detailsListField"></asp:Label>
            <asp:Label runat="server" Text='<%# Eval("WeaponType_Name") %>' CssClass="detailsListData"></asp:Label>
        </li>
        <li runat="server" class="detailsListItem">
