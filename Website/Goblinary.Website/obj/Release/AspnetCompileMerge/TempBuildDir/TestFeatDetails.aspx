<%@ Page Title="Feat" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TestFeatDetails.aspx.cs" Inherits="Goblinary.Website.TestFeatDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
	<div class="loading">
		<h3>Saving character data...</h3>
		<img src="/Images/spiffygif.gif" alt="" /></div>
	<section class="featured">
		<div class="content-wrapper">
			...
			<hr />
			<small><b>Filter</b> on all columns at once: </small>
			<input class="search" type="search" data-column="all">
			<br />
			<small>Reset all column filters, including Master Filter (above): </small>
			<button type="button" class="reset">Reset All Filters</button><br />
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
	...
	<button type="button" class="ShowHideButton">Show/Hide Filtering Instructions</button>
	<span><small>(Hint: Use SHIFT key to sort multiple columns.)</small></span>
