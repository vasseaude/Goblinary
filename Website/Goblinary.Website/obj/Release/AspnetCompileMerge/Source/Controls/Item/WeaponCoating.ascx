<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WeaponCoating.ascx.cs" Inherits="Goblinary.Website.Controls.Item.WeaponCoating" %>
<asp:GridView ID="ItemsGridView" runat="server" CssClass="tablesorter custom-popup" AutoGenerateColumns="false">
    <Columns>
        ...
        <asp:BoundField DataField="WeaponCoatingType_Name" HeaderText="Weapon Coating Type" SortExpression="" />
    </Columns>
</asp:GridView>
<asp:ListView runat="server" ID="ItemListView">
    ...
    <ItemTemplate>
        ...
        <li runat="server" class="detailsListItem">
            <asp:Label runat="server" Text="Weapon Coating Type:" CssClass="detailsListField"></asp:Label>
            <asp:Label runat="server" Text='<%# Eval("WeaponCoatingType_Name") %>' CssClass="detailsListData"></asp:Label>
        </li>
        <li runat="server" class="detailsListItem">
