<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HoldingKit.ascx.cs" Inherits="Goblinary.Website.Controls.Item.Holding" %>
...
<asp:ListView runat="server" ID="ItemListView">
    ...
    <ItemTemplate>
		<li runat="server" class="detailsListItem">
            ...
            <asp:HyperLink runat="server" NavigateUrl='<%# "~/StructureDetails?structure=" + HttpUtility.UrlEncode(Eval("Holding_Name").ToString()) %>' Text='<%# Eval("Holding_Name") %>' CssClass="detailsListData" />
		</li>
		<li runat="server" class="detailsListItem">
